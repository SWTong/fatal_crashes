...
Florida is ranked % in the year % in terms of the number of accidents that occurred. A lot of research has been done on the demographics of accidents already, such as age and gender, so I will be mainly focusing on the geographics of the accidents, particularly in the Tampa Bay Area.
...
__Question: How many accidents occurred in each county in the Tampa Bay Area? Is there a difference in the number of accidents between rural and urban areas?__
...
__Question: What months had the highest number of accident in the Tampa Bay Area in 2016?__
